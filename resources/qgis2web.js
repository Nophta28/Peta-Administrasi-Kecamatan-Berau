...
map.getView().fit([12717195.455758, 3556.450684, 13390477.276665, 430119.934758], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Administrasi</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (228 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'kecamatan di kabupaten berau merupakan suatu wilayah atau satuan wilayah administrasi yang berperan dalam mendukung pemerintahan dan membangun daerah. informasi spasial batas kecamatan diperlukan untuk media peta secara efektif.';
            }
